...
class WeeklyGrowthReport(Base):
    ...
    accounts_covered: Mapped[list[dict[str, object]]] = mapped_column(JSON, default=list)
    summary: Mapped[str] = mapped_column(Text)
    fleet_snapshot: Mapped[dict[str, object]] = mapped_column(JSON)
    top_clips: Mapped[list[dict[str, object]]] = mapped_column(JSON, default=list)
    underperforming_clips: Mapped[list[dict[str, object]]] = mapped_column(JSON, default=list)
    experiment_readout: Mapped[dict[str, object]] = mapped_column(JSON)
    workflow_metrics: Mapped[dict[str, object]] = mapped_column(JSON)
    next_experiment: Mapped[dict[str, object]] = mapped_column(JSON)
    content_backlog_suggestions: Mapped[list[str]] = mapped_column(JSON, default=list)
